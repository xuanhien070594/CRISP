...
namespace CRISP
{
    ...
    public:
        ...
        ObjectiveFunction(size_t variableDim, const std::string &modelName, const std::string &folderName,
                          const std::string &functionName, const ad_function_t &function,
                          bool regenerateLibrary = false,
        ...
        {
            cppadInterface_ = std::make_unique<CppAdInterface>(variableDim, modelName, folderName, functionName,
        ...
        ObjectiveFunction(size_t variableDim, size_t parameterDim, const std::string &modelName,
            ...
            : specifiedFunctionLevel_(specifiedFunctionLevel), functionName_(functionName)
        {
            cppadInterface_ = std::make_unique<CppAdInterface>(variableDim, parameterDim, modelName, folderName,
                                                               functionName, function, infoLevel, regenerateLibrary);
            variableDim_ = variableDim;
        ...
        ObjectiveFunction(size_t variableDim, const std::string &functionName, const function_t &function)
        ...
        ObjectiveFunction(size_t variableDim, size_t parameterDim, const std::string &functionName,
                          const function_with_param_t &function)
            : functionName_(functionName)
        {
            variableDim_ = variableDim;
            parameterDim_ = parameterDim;
        ...
        {
            cppadInterface_ = std::make_unique<CppAdInterface>(variableDim, parameterDim, modelName, folderName,
                                                               functionName, infoLevel, regenerateLibrary);
            variableDim_ = variableDim;
            parameterDim_ = parameterDim;
            funDim_ = 1;
            isParameterized_ = true;
    ...
    protected:
        SpecifiedFunctionLevel specifiedFunctionLevel_ = SpecifiedFunctionLevel::NONE;
